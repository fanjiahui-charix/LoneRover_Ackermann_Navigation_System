...
virtual-vehicle remapped by the launch command, so this process never touches
the base driver or /cmd_vel_safe.
"""
...
from ackermann_vehicle_simulator import AckermannPlant
